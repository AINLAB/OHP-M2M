...
public class D10415MeasurmentResource extends CoapResource{
	...
	public D10415MeasurmentResource(String name, Device10415 d10415){
		super(name);
		this.setDevice10415(d10415);
		setObservable(true);
		getAttributes().setTitle("D10415 Measurements");
		getAttributes().addResourceType("D10415 Measurements");
	...
	public void handleGET(CoapExchange exchange) {
		...
		exchange.respond(CONTENT, device10415.getM_MetricString(),dataCf);
