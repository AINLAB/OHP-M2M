...
public class D10472MeasurmentResource extends CoapResource{
	...
	public D10472MeasurmentResource(String name, Device10472 d10472){
		super(name);
		this.setDevice10472(d10472);
		setObservable(true);
		getAttributes().setTitle("D10472 Measurements");
		getAttributes().addResourceType("D10472 Measurements");
	...
	public void handleGET(CoapExchange exchange) {
		...
		exchange.respond(CONTENT, device10472.getM_MetricString(),dataCf);
