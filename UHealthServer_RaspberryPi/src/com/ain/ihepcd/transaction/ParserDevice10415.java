...
public class ParserDevice10415{
		...
		try {
			...
			while(it.hasNext())
			{
				...
				if(e.getName().equals("NUMERIC-BodyWeight"))
				{
					...
					numericBdyWeight.setNumeric_UnitCode(e.getChild("MDC_ATTR_UNIT_CODE").getText());
					numericBdyWeight.setNumeric_AttributeValueMap(e.getChild("MDC_ATTR_ATTRIBUTE_VAL_MAP").getText());
					numericBdyWeight.setNumeric_SimpleNuObservedValue(e.getChild("MDC_ATTR_NU_VAL_OBS_SIMP").getText());
				}
				...
				if(e.getName().equals("NUMERIC-BodyHeight"))
				{
					...
					numericBdyHeight.setNumeric_BasicNuObservedValue(e.getChild("MDC_ATTR_NU_VAL_OBS_BASIC").getText());
				}
				...
				if(e.getName().equals("NUMERIC-BodyMassIdx"))
				{
					...
					numericBdyMassIdx.setNumeric_AttributeValueMap(e.getChild("MDC_ATTR_ATTRIBUTE_VAL_MAP").getText());
