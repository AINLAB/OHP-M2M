package com.liwei.medicaldevice.GlucoseMeter.Device;
...
public class GlucoseMeterDevice {
	private static Log LOGGER = LogFactory.getLog(GlucoseMeterDevice.class);
