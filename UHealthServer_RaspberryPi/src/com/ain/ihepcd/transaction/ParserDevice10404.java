...
public class ParserDevice10404{
	
	public ObjectNumeric numericSpO2;
	public ObjectNumeric numericPulseRate;
	public ORU_R01 m_Msg;
	
	public ParserDevice10404(){
		numericSpO2 = new ObjectNumeric();
	...
	public void ParsingMetricXML(String pathMetric){
		...
		try {
			...
			while(it.hasNext())
			{
				...
				if(e.getName().equals("NUMERIC-SpO2"))
				{
					numericSpO2.setNumeric_Type(e.getChild("MDC_ATTR_ID_TYPE").getText());
					numericSpO2.setNumeric_MetricSpecSmall(e.getChild("MDC_ATTR_METRIC_SPEC_SMALL").getText());
					numericSpO2.setNumeric_UnitCode(e.getChild("MDC_ATTR_UNIT_CODE").getText());
					numericSpO2.setNumeric_AttributeValueMap(e.getChild("MDC_ATTR_ATTRIBUTE_VAL_MAP").getText());
					numericSpO2.setNumeric_BasicNuObservedValue(e.getChild("MDC_ATTR_NU_VAL_OBS_BASIC").getText());
				}
