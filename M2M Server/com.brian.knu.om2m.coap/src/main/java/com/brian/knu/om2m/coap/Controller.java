...
/**
 * Execute received requests from OM2M to the specific technologies4 Its work is
...
public class Controller implements IpuService {
	...
	public ResponseConfirm doRetrieve(RequestIndication requestIndication) {
		...
		String appId = parts[2];
		String content;
		if (appId.equals(CardioVascularMonitor.sensorId)) {
			content = Mapper
					.getSensorDataRep(CardioVascularMonitor.sensorValue);
	...
	public String getAPOCPath() {
		// TODO Auto-generated method stub
		return CardioVascularMonitor.tempId;
	}
