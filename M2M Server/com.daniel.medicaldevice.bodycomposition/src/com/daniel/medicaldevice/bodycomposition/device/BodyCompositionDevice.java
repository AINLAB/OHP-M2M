package com.daniel.medicaldevice.bodycomposition.device;
...
public class BodyCompositionDevice {
	private static Log LOGGER = LogFactory.getLog(BodyCompositionDevice.class);
	private final static String APOCPATH = "BCM";
	private final static String TYPE = "BodyCompositionMonitor";
